 ...
 * 对应后端：GetListAsync
 */
export function getList(params: FileQuery): Promise<TaktPagedResult<TaktFile>> {
  return request({
    url: '/api/TaktFiles/list',
    method: 'get',
    params
  })
}
 ...
 * 对应后端：GetByIdAsync
 */
export function getById(id: string): Promise<TaktFile> {
  return request({
    url: `/api/TaktFiles/${id}`,
    method: 'get'
  })
}
...
export function getByCode(fileCode: string): Promise<TaktFile> {
  return request({
    url: `/api/TaktFiles/code/${fileCode}`,
    method: 'get'
  })
}
 ...
 * 对应后端：CreateAsync
 */
export function create(data: FileCreate): Promise<TaktFile> {
  return request({
    url: '/api/TaktFiles',
    method: 'post',
    data
 ...
 * 对应后端：UpdateAsync
 */
export function update(id: string, data: FileUpdate): Promise<TaktFile> {
  return request({
    url: `/api/TaktFiles/${id}`,
    method: 'put',
    data
 ...
 */
export function deleteBatch(ids: string[]): Promise<void> {
  return request({
    url: '/api/TaktFiles/batch',
    method: 'delete',
    data: ids
  })
}
 ...
 */
export function updateStatus(data: FileStatus): Promise<TaktFile> {
  return request({
    url: '/api/TaktFiles/status',
    method: 'put',
    data
  })
}
...
export function incrementDownloadCount(data: FileIncrementDownloadCount): Promise<void> {
  return request({
    url: '/api/TaktFiles/increment-download-count',
    method: 'post',
    data
  })
}
