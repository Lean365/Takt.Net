...
[ApiModule("SignalR", "SignalR管理")]
[Authorize]
[TaktPermission("signalr:online", "在线用户管理")]
public class TaktOnlinesController : TaktControllerBase
{
    ...
    [HttpGet("list")]
    [TaktPermission("signalr:online:list", "查询在线用户列表")]
    ...
    [HttpGet("{id}")]
    [TaktPermission("signalr:online:query", "查询在线用户详情")]
    ...
    [TaktPermission("signalr:online:query", "根据连接ID查询在线用户")]
    ...
    /// <returns>在线用户DTO</returns>
    [HttpPost]
    [TaktPermission("signalr:online:create", "创建在线用户")]
    ...
    /// <returns>任务</returns>
    [HttpDelete("{id}")]
    [TaktPermission("signalr:online:delete", "删除在线用户")]
    ...
    [TaktPermission("signalr:online:delete", "根据连接ID删除在线用户")]
    ...
    /// <returns>任务</returns>
    [HttpDelete("batch")]
    [TaktPermission("signalr:online:delete", "批量删除在线用户")]
    ...
    [TaktPermission("signalr:online:update", "更新最后活动时间")]
    ...
    [HttpGet("export")]
    [TaktPermission("signalr:online:export", "导出在线用户")]
