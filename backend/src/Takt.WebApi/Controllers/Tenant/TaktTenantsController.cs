...
using Takt.Application.Tenant;
using Takt.Domain.Interfaces;
using Takt.Infrastructure.Attributes;
using Takt.Shared.Models;
using Takt.WebApi.Controllers;

namespace Takt.WebApi.Controllers.Tenant;
...
[TaktPermission("tenant:tenant", "租户管理")]
public class TaktTenantsController : TaktControllerBase
{
    ...
    [HttpGet("list")]
    [TaktPermission("tenant:tenant:list", "查询租户列表")]
    ...
    [HttpGet("{id}")]
    [TaktPermission("tenant:tenant:query", "查询租户详情")]
    ...
    [HttpGet("options")]
    [TaktPermission("tenant:tenant:list", "查询租户选项")]
    ...
    /// <returns>租户DTO</returns>
    [HttpPost]
    [TaktPermission("tenant:tenant:create", "创建租户")]
    ...
    /// <returns>租户DTO</returns>
    [HttpPut("{id}")]
    [TaktPermission("tenant:tenant:update", "更新租户")]
    ...
    [HttpDelete("{id}")]
    [TaktPermission("tenant:tenant:delete", "删除租户")]
    ...
    /// <returns>租户DTO</returns>
    [HttpPut("status")]
    [TaktPermission("tenant:tenant:status", "更新租户状态")]
    ...
    [TaktPermission("tenant:tenant:query", "查询租户用户")]
    ...
    [TaktPermission("tenant:tenant:update", "分配租户用户")]
    ...
    [HttpGet("template")]
    [TaktPermission("tenant:tenant:import", "获取导入模板")]
    ...
    [HttpPost("import")]
    [TaktPermission("tenant:tenant:import", "导入租户")]
    ...
    [HttpPost("export")]
    [TaktPermission("tenant:tenant:export", "导出租户")]
