...
[Authorize]
[TaktPermission("logging:quartzlog", "任务日志管理")]
public class TaktQuartzLogsController : TaktControllerBase
{
    ...
    [HttpGet("list")]
    [TaktPermission("logging:quartzlog:list", "查询任务日志列表")]
    ...
    [HttpGet("{id}")]
    [TaktPermission("logging:quartzlog:query", "查询任务日志详情")]
    ...
    /// <returns>任务日志DTO</returns>
    [HttpPost]
    [TaktPermission("logging:quartzlog:create", "创建任务日志")]
    ...
    /// <returns>任务</returns>
    [HttpDelete("{id}")]
    [TaktPermission("logging:quartzlog:delete", "删除任务日志")]
    ...
    /// <returns>任务</returns>
    [HttpDelete("batch")]
    [TaktPermission("logging:quartzlog:delete", "批量删除任务日志")]
    ...
    [HttpGet("export")]
    [TaktPermission("logging:quartzlog:export", "导出任务日志")]
