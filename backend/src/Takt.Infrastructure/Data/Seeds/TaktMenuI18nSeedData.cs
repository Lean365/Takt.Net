...
public class TaktMenuL10nSeedData : ITaktSeedData
{
    ...
    public async Task<(int InsertCount, int UpdateCount)> SeedAsync(IServiceProvider serviceProvider, string configId)
    {
        ...
        try
        {
            ...
            // 2. 获取支持的语言（仓储会根据 TaktLanguage 实体类型自动切换到 Routine 数据库 ConfigId="5"）
            ...
            // 4. 为每个翻译键创建或更新翻译记录（仓储会根据 TaktTranslation 实体类型自动切换到 Routine 数据库 ConfigId="5"）
    ...
    private static List<TaktTranslation> GetAllMenuTranslations()
    {
        return new List<TaktTranslation>
        {
            ...
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "menu.workflow.myprocess", TranslationValue = "عمليتي", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "menu.workflow.myprocess", TranslationValue = "My Process", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "menu.workflow.myprocess", TranslationValue = "Mi Proceso", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "menu.workflow.myprocess", TranslationValue = "Mon Processus", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "menu.workflow.myprocess", TranslationValue = "マイプロセス", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "menu.workflow.myprocess", TranslationValue = "내 프로세스", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "menu.workflow.myprocess", TranslationValue = "Мой процесс", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "menu.workflow.myprocess", TranslationValue = "我的流程", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "menu.workflow.myprocess", TranslationValue = "我的流程", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            // menu.workflow.processdesign
            new TaktTranslation { CultureCode = "ar-SA", ResourceKey = "menu.workflow.processdesign", TranslationValue = "تصميم العملية", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "menu.workflow.processdesign", TranslationValue = "Process Design", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "menu.workflow.processdesign", TranslationValue = "Diseño Proceso", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "menu.workflow.processdesign", TranslationValue = "Design Processus", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ja-JP", ResourceKey = "menu.workflow.processdesign", TranslationValue = "プロセス設計", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ko-KR", ResourceKey = "menu.workflow.processdesign", TranslationValue = "프로세스 설계", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "menu.workflow.processdesign", TranslationValue = "Дизайн процесса", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-CN", ResourceKey = "menu.workflow.processdesign", TranslationValue = "流程设计", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "zh-TW", ResourceKey = "menu.workflow.processdesign", TranslationValue = "流程設計", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "menu.statistics.kanban.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "menu.statistics.kanban.hr", TranslationValue = "RRHH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "menu.statistics.kanban.hr", TranslationValue = "RH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "menu.statistics.kanban.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "menu.statistics.report.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "menu.statistics.report.hr", TranslationValue = "RRHH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "menu.statistics.report.hr", TranslationValue = "RH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "menu.statistics.report.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "en-US", ResourceKey = "menu.statistics.board.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "es-ES", ResourceKey = "menu.statistics.board.hr", TranslationValue = "RRHH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            new TaktTranslation { CultureCode = "fr-FR", ResourceKey = "menu.statistics.board.hr", TranslationValue = "RH", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
            ...
            new TaktTranslation { CultureCode = "ru-RU", ResourceKey = "menu.statistics.board.hr", TranslationValue = "HR", ResourceType = "Frontend", ResourceGroup = "Menu", OrderNum = 0 },
