...
public interface ITaktFileService
{
    ...
    Task<TaktPagedResult<TaktFileDto>> GetListAsync(TaktFileQueryDto queryDto);
    ...
    /// <returns>文件DTO</returns>
    Task<TaktFileDto> CreateAsync(TaktFileCreateDto dto);
    ...
    /// <returns>文件DTO</returns>
    Task<TaktFileDto> UpdateAsync(long id, TaktFileUpdateDto dto);
    ...
    /// <returns>文件DTO</returns>
    Task<TaktFileDto> UpdateStatusAsync(TaktFileStatusDto dto);
    ...
    /// <returns>文件名和文件内容</returns>
    Task<(string fileName, byte[] content)> ExportAsync(TaktFileQueryDto query, string? sheetName, string? fileName);
}
