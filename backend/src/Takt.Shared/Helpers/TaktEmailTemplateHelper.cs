...
public static class TaktEmailTemplateHelper
{
    ...
    public static string GetFilledBody(string templateName, IReadOnlyDictionary<string, string?> variables, string? templatesBasePath = null)
    {
        var content = LoadTemplate(templateName, templatesBasePath);
    ...
    public static string LoadTemplate(string templateName, string? templatesBasePath = null)
    {
