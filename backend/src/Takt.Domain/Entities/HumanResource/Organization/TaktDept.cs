...
[SugarIndex("ix_takt_humanresource_organization_dept_DeptHead", nameof(DeptHead), OrderByType.Asc)]
...
public class TaktDept : TaktEntityBase
{
    ...
    /// 部门负责人
    /// </summary>
    [SugarColumn(ColumnName = "dept_head", ColumnDescription = "部门负责人", ColumnDataType = "nvarchar", Length = 50, IsNullable = true)]
