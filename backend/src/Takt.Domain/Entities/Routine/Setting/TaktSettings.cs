...
namespace Takt.Domain.Entities.Routine.Setting;
...
public class TaktSettings : TaktEntityBase
{
    ...
    /// 是否加密（0=是，1=否）
    /// </summary>
    [SugarColumn(ColumnName = "is_encrypted", ColumnDescription = "是否加密", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
