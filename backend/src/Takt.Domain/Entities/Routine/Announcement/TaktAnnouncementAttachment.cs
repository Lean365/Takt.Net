...
// 文件名称：TaktAnnouncementAttachment.cs
// 创建时间：2025-01-20
// 创建人：Takt365(Cursor AI)
// 功能描述：Takt公告附件实体，定义公告附件领域模型
// 
...
/// Takt公告附件实体
/// </summary>
[SugarTable("takt_routine_announcement_attachment", "公告附件表")]
[SugarIndex("ix_takt_routine_announcement_attachment_announcement_id", nameof(AnnouncementId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_announcement_attachment_file_id", nameof(FileId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_announcement_attachment_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_routine_announcement_attachment_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktAnnouncementAttachment : TaktEntityBase
{
    /// <summary>
