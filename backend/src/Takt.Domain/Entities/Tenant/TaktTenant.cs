...
namespace Takt.Domain.Entities.Tenant;

/// <summary>
/// Takt租户实体
/// </summary>
[SugarTable("takt_tenant", "租户表")]
[SugarIndex("ix_takt_tenant_tenant_code", nameof(TenantCode), OrderByType.Asc, true)]
[SugarIndex("ix_takt_tenant_config_id", nameof(ConfigId), OrderByType.Asc, true)]
[SugarIndex("ix_takt_tenant_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
[SugarIndex("ix_takt_tenant_tenant_status", nameof(TenantStatus), OrderByType.Asc)]
