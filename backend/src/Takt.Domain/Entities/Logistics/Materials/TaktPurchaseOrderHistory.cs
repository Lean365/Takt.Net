...
// 文件名称：TaktPurchaseOrderHistory.cs
// 创建时间：2025-01-20
// 创建人：Takt365(Cursor AI)
// 功能描述：Takt采购订单变更记录实体，定义采购订单变更记录领域模型
// 
...
/// Takt采购订单变更记录实体
/// </summary>
[SugarTable("takt_logistics_materials_purchase_order_history", "采购订单变更记录表")]
[SugarIndex("ix_takt_logistics_materials_purchase_order_history_order_id", nameof(OrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_order_history_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_materials_purchase_order_history_change_user_id", nameof(ChangeUserId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_order_history_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_materials_purchase_order_history_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktPurchaseOrderHistory : TaktEntityBase
{
    /// <summary>
    /// 订单ID（关联采购订单表，序列化为string以避免Javascript精度问题）
    /// </summary>
