...
/// PCBA明细实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_oph_pcba_output_detail", "PCBA日报明细表")]
[SugarIndex("ix_takt_logistics_manufacturing_oph_pcba_output_detail_pcba_output_id", nameof(PcbaOutputId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_pcba_output_detail_time_period", nameof(TimePeriod), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_pcba_output_detail_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_pcba_output_detail_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
