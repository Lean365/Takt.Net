...
/// 组立日报明细（产出子表）实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_oph_assy_output_detail", "组立日报明细表")]
[SugarIndex("ix_takt_logistics_manufacturing_oph_assy_output_detail_assy_output_id", nameof(AssyOutputId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_assy_output_detail_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_oph_assy_output_detail_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
