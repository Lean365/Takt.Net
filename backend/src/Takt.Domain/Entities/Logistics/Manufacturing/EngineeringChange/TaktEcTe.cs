...
// 文件名称：TaktEcnManufacturingTechnology.cs
// 创建时间：2025-02-02
...
/// 设变-制造技术课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_te", "设变制造技术课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_te_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_te_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_te_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcTe : TaktEntityBase
{
    /// <summary>
