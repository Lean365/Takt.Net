...
/// 设变-财务课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_fins", "设变财务课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_fins_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_fins_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_fins_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcFins : TaktEntityBase
{
    /// <summary>
