...
/// 设变-报关课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_cus", "设变报关课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_cus_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_cus_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_cus_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcCus : TaktEntityBase
{
    /// <summary>
