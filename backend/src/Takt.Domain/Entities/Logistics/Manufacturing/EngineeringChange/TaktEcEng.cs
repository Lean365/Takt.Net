...
/// 设变-技术课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_eng", "设变技术课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_eng_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_eng_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_eng_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcEng : TaktEntityBase
{
    /// <summary>
