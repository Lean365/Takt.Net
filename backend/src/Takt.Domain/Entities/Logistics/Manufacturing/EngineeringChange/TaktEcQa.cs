...
// 文件名称：TaktEcnQualityAssurance.cs
// 创建时间：2025-02-02
...
/// 设变-品管课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_qa", "设变品管课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_qa_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_qa_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_qa_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcQa : TaktEntityBase
{
    /// <summary>
    ...
    /// 检验批次
    /// </summary>
    [SugarColumn(ColumnName = "inspection_batch", ColumnDescription = "检验批次", Length = 100, ColumnDataType = "nvarchar", IsNullable = true)]
    public string? InspectionBatch { get; set; }

    /// <summary>
    /// 抽样号码
    /// </summary>
    [SugarColumn(ColumnName = "sampling_no", ColumnDescription = "抽样号码", Length = 100, ColumnDataType = "nvarchar", IsNullable = true)]
