...
/// 设变-电脑课实体
/// </summary>
[SugarTable("takt_logistics_manufacturing_ecn_it", "设变电脑课表")]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_it_ecn_detail_id", nameof(EcnDetailId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_it_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_manufacturing_ecn_it_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktEcIt : TaktEntityBase
{
    /// <summary>
