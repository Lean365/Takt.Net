...
// 文件名称：TaktSalesOrderHistory.cs
// 创建时间：2025-01-20
// 创建人：Takt365(Cursor AI)
// 功能描述：Takt销售订单变更记录实体，定义销售订单变更记录领域模型
// 
...
/// Takt销售订单变更记录实体
/// </summary>
[SugarTable("takt_logistics_sales_order_history", "销售订单变更记录表")]
[SugarIndex("ix_takt_logistics_sales_order_history_order_id", nameof(OrderId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_history_change_time", nameof(ChangeTime), OrderByType.Desc)]
[SugarIndex("ix_takt_logistics_sales_order_history_change_user_id", nameof(ChangeUserId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_history_config_id", nameof(ConfigId), OrderByType.Asc)]
[SugarIndex("ix_takt_logistics_sales_order_history_is_deleted", nameof(IsDeleted), OrderByType.Asc)]
public class TaktSalesOrderHistory : TaktEntityBase
{
    /// <summary>
    /// 订单ID（关联销售订单表，序列化为string以避免Javascript精度问题）
    /// </summary>
